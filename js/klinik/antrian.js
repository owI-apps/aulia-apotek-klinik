        ...
        statuses.forEach(function(stat) {
            ...
            filtered.forEach(function(a) {
                ...
                if (a.status === 'dilayani') {
                    ...
                    html += '    <button onclick="alert(\'Ke Rekam Medis: ' + a.id + '\')" class="text-xs bg-primary-600 text-white px-3 py-1.5 rounded-lg font-medium hover:bg-primary-700 flex items-center gap-1"><i data-lucide="stethoscope" class="w-3 h-3"></i> Buka RM</button>';
